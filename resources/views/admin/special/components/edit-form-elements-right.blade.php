...
<div class="card">
    ...
    <div class="card-block">
        ...
        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('published_at'), 'has-success': this.fields.published_at && this.fields.published_at.valid }">
            <label for="published_at" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-2' : 'col-md-4'">{{ trans('admin.things-to-do.columns.published_at') }}</label>
...
@include('brackets/admin-ui::admin.includes.media-uploader', [
    'mediaCollection' => app(App\Models\Special::class)->getMediaCollection('gallery'),
    'media' => $special->getThumbs200ForCollection('gallery'),
    'label' => 'Special Image'
])
