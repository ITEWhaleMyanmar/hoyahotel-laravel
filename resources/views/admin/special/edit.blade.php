...
@section('title', trans('admin.special.actions.edit', ['name' => $special->title]))
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-pencil"></i> {{ trans('admin.special.actions.edit', ['name' => $special->title]) }}
                                </div>
                                <div class="card-body">
