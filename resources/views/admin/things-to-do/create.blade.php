...
@section('title', trans('admin.things-to-do.actions.create'))
...
@section('body')
    ...
    <div class="container-xl">
        ...
        <things-to-do-form
            :action="'{{ url('admin/things-to-dos') }}'"
            v-cloak
            inline-template>
            ...
            <form class="form-horizontal form-create" method="post" @submit.prevent="onSubmit" :action="action" novalidate>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-header">
                                <i class="fa fa-plus"></i> {{ trans('admin.things-to-do.actions.create') }}
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-5 col-xxl-4">
                        @include('admin.things-to-do.components.form-elements-right')
                    </div>
                </div>
