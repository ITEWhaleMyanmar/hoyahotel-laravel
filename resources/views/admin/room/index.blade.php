                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'title'">{{ trans('admin.room.columns.title') }}</th>
                                        <th is='sortable' class="text-center" :column="'published_at'">{{ trans('admin.room.columns.published_at') }}</th>
                                        <th is='sortable' :column="'enabled'">{{ trans('admin.room.columns.enabled') }}</th>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        <td>@{{ item.title }}</td>
                                            ...
                                            <span v-if="item.published_at <= now">
                                                ...
                                                <span v-if="item.published_at > now">
                                                <small>{{ trans('admin.room.actions.will_be_published') }}</small><br />
                                                @{{ item.published_at | datetime('DD.MM.YYYY, HH:mm') }}
