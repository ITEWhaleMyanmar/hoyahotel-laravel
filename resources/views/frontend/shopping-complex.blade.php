...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="images/shopping-complex.jpg" alt="Shopping Complex" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                ...
                <ul class="list-group">
                    <div class="list-group-item">
                        <ul class="list-unstyled">
                            <li class="page-link border-0"><a href="fac-business-center.php" class="text-dark">Business
                                    Center</a></li>
                            <hr>
                            <li class="page-link border-0 link-active"><a href="fac-shopping-complex.php" class="text-white">Shopping
                                    Complex</a></li>
                        </ul>
                    </div>
                </ul>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">Shopping Complex</h3>
                <hr>
                ...
                <hr>
                <p><span class="font-weight-bold">Location:</span> Level 3</p>
            </div>
        </div>
    </div>
</div>
