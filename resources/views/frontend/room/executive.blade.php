...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="images/room-executive-deluxe.jpg" alt="Room Executve Deluxe" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
            <div class="col-md-3">
                <ul class="list-group">
                    ...
                    <div class="list-group-item">
                        ...
                        <ul class="list-unstyled">
                            <hr>
                            <li class="page-link border-0 link-active"><a href="room-executive-deluxe.php" class="text-white">Executive
                                    Deluxe</a></li>
                            <hr>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">Executive Deluxe Room</h3>
                <hr>
