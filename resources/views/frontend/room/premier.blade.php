    ...
    <div class="content">
        <div class="container">
            <div class="row pb-5 pt-5">
                <div class="col-md-12">
                    <img src="images/room-premier.jpg" alt="Room Premier" class="img-fluid">
                </div>
            </div>
            <div class="row content-row">
                    ...
                    <ul class="list-group">
                        <div class="list-group-item">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <hr>
                                <li class="page-link link-active border-0"><a href="room-premier.php" class="text-white">Premier</a></li>
                            </ul>
                        </div>
                        <div class="list-group-item">
                ...
                <div class="col-md-9 content-col">
                    <h3 class="font-weight-bold">Premier Room</h3>
                    <hr>
