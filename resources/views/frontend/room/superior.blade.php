...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="images/room-superior.jpg" alt="Room Superior" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                ...
                <ul class="list-group">
                    <div class="list-group-item">
                        ...
                        <ul class="list-unstyled">
                            <hr>
                            <li class="page-link link-active border-0"><a href="room-superior.php"
                                    class="text-white">Superior</a></li>
                            <hr>
                            <li class="page-link border-0"><a href="room-deluxe.php" class="text-dark">Deluxe</a></li>
                            <hr>
                    ...
                    <div class="list-group-item">
                        ...
                        <ul class="list-unstyled">
                            <hr>
                            <li class="page-link border-0"><a href="room-executive-deluxe.php"
                                    class="text-dark">Executive
                                    Deluxe</a></li>
                            <hr>
                            <li class="page-link border-0"><a href="room-executive-business.php"
                                    class="text-dark">Executive
                                    Business</a></li>
                            <hr>
                            <li class="page-link border-0"><a href="room-hoya-suite.php" class="text-dark">Hoya
                                    Suite</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">Superior Room</h3>
                <hr>
