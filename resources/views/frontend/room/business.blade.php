...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="images/room-executive-business.jpg" alt="Room Executive Business" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                    ...
                    <div class="list-group-item">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="page-link border-0"><a href="room-executive-deluxe.php" class="text-dark">Executive
                                    Deluxe</a></li>
                            <hr>
                            <li class="page-link link-active border-0"><a href="room-executive-business.php" class="text-white">Executive
                                    Business</a></li>
                            <hr>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">Executive Business Room</h3>
                <hr>
