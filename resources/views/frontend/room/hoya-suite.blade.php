...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="images/room-hoya-suite.jpg" alt="Hoya Suite" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                    ...
                    <div class="list-group-item">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="page-link border-0"><a href="room-executive-business.php" class="text-dark">Executive
                                    Business</a></li>
                            <hr>
                            <li class="page-link border-0 link-active "><a href="room-hoya-suite.php" class="text-white">Hoya Suite</a>
                            </li>
                        </ul>
                    </div>
                </ul>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">Hoya Suite</h3>
                <hr>
