...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="images/b&b-main.jpg" alt="Bed and Breakfast" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                ...
                <ul class="list-group">
                    <div class="list-group-item">
                        <ul class="list-unstyled">
                            <li class="page-link border-0 link-active"><a href="spec-bed-and-breakfast.php" class="text-white">Bed & Breakfast</a></li>
                            <hr>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">Bed & Breakfast</h3>
                <hr>
