...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="media/{{ $data[2]->media[0]->id . '/' .$data[2]->media[0]->file_name}}" alt="Advanced Booking" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                ...
                <ul class="list-group">
                    <div class="list-group-item">
                        <ul class="list-unstyled">
                            <li class="page-link border-0"><a href="{{ url('breakfast') }}" class="text-dark">{{$data[0]->title}}</a></li>
                            <hr>
                            <li class="page-link border-0"><a href="{{ url('happy-hour') }}" class="text-dark">{{$data[1]->title}}</a></li>
                            <hr>
                            <li class="page-link border-0 link-active"><a href="{{ url('booking') }}" class="text-white">{{$data[2]->title}}</a></li>
                            <hr>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">{{$data[3]->title}}</h3>
                <hr>
                <p class="pt-3">{{$data[3]->perex}}</p>
                <br>
