...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="images/advanced-booking-main.jpg" alt="Advanced Booking" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                ...
                <ul class="list-group">
                    <div class="list-group-item">
                        <ul class="list-unstyled">
                            ...
                            <hr>
                            <li class="page-link border-0"><a href="spec-happy-hour.php" class="text-dark">Happy
                                    Hour</a></li>
                            <hr>
                            <li class="page-link border-0 link-active"><a href="spec-advanced-booking.php" class="text-white">Advanced Booking</a></li>
                            <hr>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">Advanced Booking</h3>
                <hr>
