...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="media/{{ $data[1]->media[0]->id . '/' .$data[1]->media[0]->file_name}}" alt="Happy Hour" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                ...
                <ul class="list-group">
                    <div class="list-group-item">   
                        <ul class="list-unstyled">
                            ...
                            <hr>
                            <li class="page-link border-0 link-active"><a href="{{ url('happy-hour') }}" class="text-white">{{$data[1]->title}}</a></li>
                            <hr>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">{{$data[2]->title}}</h3>
                <hr>
                <p class="pt-3">{{$data[2]->perex}}</p>
                <br>
