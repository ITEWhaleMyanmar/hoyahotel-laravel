...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="media/{{ $data[3]->media[0]->id . '/' .$data[3]->media[0]->file_name}}" alt="Hotel Voucher" class="img-fluid">
            </div>
        </div>
                ...
                <ul class="list-group">
                    <div class="list-group-item">
                        <ul class="list-unstyled">
                            ...
                            <hr>
                            <li class="page-link border-0 link-active"><a href="{{ url('voucher') }}" class="text-white">{{$data[3]->title}}</a></li>
                            <hr>
                        </ul>
                    </div>
                </ul>
