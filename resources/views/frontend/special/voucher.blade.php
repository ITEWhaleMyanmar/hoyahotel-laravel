...
<div class="content">
    <div class="container">
        <div class="row pb-5 pt-5">
            <div class="col-md-12">
                <img src="images/advanced-booking-main.jpg" alt="Hotel Voucher" class="img-fluid">
            </div>
        </div>
        <div class="row content-row">
                ...
                <ul class="list-group">
                    <div class="list-group-item">
                        <ul class="list-unstyled">
                            ...
                            <hr>
                            <li class="page-link border-0 link-active"><a href="spec-hotel-voucher.php" class="text-white">Hotel
                                    Voucher</a></li>
                            <hr>
                        </ul>
                    </div>
            ...
            <div class="col-md-9 content-col">
                <h3 class="font-weight-bold">Hotel Voucher</h3>
                <hr>
