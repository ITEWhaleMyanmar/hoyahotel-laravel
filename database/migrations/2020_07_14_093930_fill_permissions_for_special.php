...
class FillPermissionsForSpecial extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSpecial constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.special',
            'admin.special.index',
            'admin.special.create',
            'admin.special.show',
            'admin.special.edit',
            'admin.special.delete',
            'admin.special.bulk-delete',
        ]);
