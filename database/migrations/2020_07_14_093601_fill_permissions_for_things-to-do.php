...
class FillPermissionsForThingsToDo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForThingsToDo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.things-to-do',
            'admin.things-to-do.index',
            'admin.things-to-do.create',
            'admin.things-to-do.show',
            'admin.things-to-do.edit',
            'admin.things-to-do.delete',
            'admin.things-to-do.bulk-delete',
        ]);
