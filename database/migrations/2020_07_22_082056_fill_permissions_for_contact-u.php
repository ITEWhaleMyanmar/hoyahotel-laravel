...
class FillPermissionsForContactU extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContactU constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.contact-u',
            'admin.contact-u.index',
            'admin.contact-u.create',
            'admin.contact-u.show',
            'admin.contact-u.edit',
            'admin.contact-u.delete',
            'admin.contact-u.bulk-delete',
        ]);
