...
class FillPermissionsForCurrentSpecialOffer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCurrentSpecialOffer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.current-special-offer',
            'admin.current-special-offer.index',
            'admin.current-special-offer.create',
            'admin.current-special-offer.show',
            'admin.current-special-offer.edit',
            'admin.current-special-offer.delete',
            'admin.current-special-offer.bulk-delete',
        ]);
